...
import "./LadderResponsive.scss";
  ...
  // renders the actual character entries of Ladder
  // renders different columns depending on whether props.account === true or false
    ...
    if (props.smallScreen) {
      ...
      return (
        <Row as="tr" id="ladderList" className="d-flex">
          ...
          {!props.account && (
            <Col as="td" className="d-none d-sm-flex" sm={2} md={2} lg={2}>
              {entry.account.twitch && (
                <a
                  href={`https://twitch.tv/${entry.account.twitch.name}`}
                  target="_blank"
      ...
      return (
        <thead>
          <Row className="d-flex">
            ...
            {!props.account && (
              <Col as="th" xs={1} sm={1} lg={1}>
                Lvl
              </Col>
            )}
            {props.account && <Col as="th">League</Col>}
            {!props.account && (
              <Col as="th" className="d-none d-sm-block" sm={2} md={2} lg={2}>
                Twitch
              </Col>
            )}
            {!props.account && (
              <Col as="th" xs={1} sm={1} md={1} lg={1}>
                Fav
              </Col>
            )}
          </Row>
